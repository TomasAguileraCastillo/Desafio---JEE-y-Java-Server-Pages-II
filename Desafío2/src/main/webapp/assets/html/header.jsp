        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand " href="index.jsp">
                	<!-- <img alt="Imagen sheraton" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTR1JxboE_Hv4zDVddyheL5ledQ6qD7loPgaA&s"
                	 width="100px" height="80px"> -->
                	 <img alt="Imagen sheraton" src="assets/img/sheraton.png"
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            <a	class="nav-link dropdown-toggle" 
                            	id="navbarDropdown" 
                            	href="#" role="button" 
                            	data-bs-toggle="dropdown" aria-expanded="false">Desafío Latam</a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="#!">Desafio Latam</a></li>
